...
public class AdminCreateNewVehicleTest_14352 extends BaseTest {

	private static final String TESTNAME = "Create new vehicle with fahrenheit and psi";
	private static final String DATA_WITH_FAHRENHEIT_AND_PSI = "dataWithFahrenheitAndPsi";
		
	private Logger log = Logger.getLogger(AdminCreateNewVehicleTest_14352.class);
	...
	public void before() {
		...
		vehicleData = readVehicleData.getVehicleData(DATA_WITH_FAHRENHEIT_AND_PSI);
	}
	...
	@Test(priority = 1, description = "1. Open Homepage and Verify Login")
	...
	@Test(priority = 2, description = "2. Create Vehicle")
	...
	@Test(priority = 3, description = "3. Check new vehicle in Administration")
	...
	@Test(priority = 4, description = "4. Check new vehicle in MyFleet")
	public void checkVehicleInMyFleet() {			
		...
		result.forEach((k, v) -> {
			...
			if (v)
				...
				ExtentTestManager.getTest().log(Status.FAIL, "4. MyFleet vehicle check: attribute " + k + " FAILED");			
		});
